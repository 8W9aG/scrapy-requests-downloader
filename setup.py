"""Setup scrapy-requests-downloader."""
...
setup(
    name='scrapy-requests-downloader',
    version='1.0.0',
    description='Scrapy middleware with requests support as an alternative to Twisted calls.',
    ...
    keywords='scrapy middleware requests',
    url='https://github.com/8W9aG/scrapy-requests-downloader',
